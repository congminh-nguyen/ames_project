...
def test_add_attributes_numerical():
    ...
    data = {
        ...
        "bsmtfin_sf_1": [400, 300, 500],
        "bsmtfin_sf_2": [200, 100, 300],
    }
    ...
    expected_total_area = pd.Series([4100, 3200, 5000], index=df.index)
    expected_pct_finished_bsmt_sf = pd.Series([0.75, 0.666667, 0.8], index=df.index)
