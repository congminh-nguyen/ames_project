...
This document provides an overview of the features available in the Ames Housing dataset. The dataset contains information from the Ames Assessor's Office used in computing assessed values for individual residential properties sold in Ames, IA from 2006 to 2010.
...
- **LotFrontage**: Linear feet of street connected to property (NA = missing data)
...
- **MasVnrType**: Masonry veneer type:
  ...
  - `Stone`: Stone
  - `NA`: Missing data
- **MasVnrArea**: Masonry veneer area in square feet (NA = missing data)
